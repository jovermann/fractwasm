...
def build_module() -> bytes:
    ...
    function_section = section(3, vec([u32(0), u32(1), u32(2), u32(3)]))
    ...
    code_section = section(10, vec([build_render_body(), build_render_stride_body(), build_guess_body(), build_render_julia_body()]))
